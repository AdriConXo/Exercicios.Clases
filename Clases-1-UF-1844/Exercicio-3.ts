...
miCoche2.setMarca = "Toyota";  // Usando el setter
miCoche2.setModelo = "Auris";  // Usando el setter
miCoche2.setNumPortas = 4;     // Usando el setter

// Mostrar la información actualizada usando el método
